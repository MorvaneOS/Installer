...
from morvane_installer.lib.disk.subvolume_menu import SubvolumeMenu
from morvane_installer.lib.menu.helpers import Confirmation, Input, Selection
from morvane_installer.lib.menu.list_manager import ListManager
from morvane_installer.lib.menu.util import prompt_dir
...
class PartitioningList(ListManager[DiskSegment]):
	...
	async def _suggest_partition_layout(
		...
		from morvane_installer.lib.disk.disk_menu import suggest_single_disk_layout
