...
from morvane_installer.lib.command import SysCommand, run
from morvane_installer.lib.disk.fido import Fido2
from morvane_installer.lib.disk.luks import Luks2, unlock_luks2_dev
from morvane_installer.lib.disk.lvm import lvm_import_vg, lvm_pvseg_info, lvm_vol_change
from morvane_installer.lib.disk.utils import (
...
from morvane_installer.lib.exceptions import DiskError, HardwareIncompatibilityError, RequirementError, SysCallError
from morvane_installer.lib.hardware import SysInfo
from morvane_installer.lib.linux_path import LPath
from morvane_installer.lib.locale.utils import verify_keyboard_layout, verify_x11_keyboard_layout
from morvane_installer.lib.log import debug, error, info, log, logger, warn
from morvane_installer.lib.mirror.mirror_handler import MirrorListHandler
from morvane_installer.lib.models.application import ZramAlgorithm
...
from morvane_installer.lib.models.network import Nic
from morvane_installer.lib.models.package_types import DEFAULT_KERNEL, Kernel
...
from morvane_installer.lib.packages.packages import installed_package
from morvane_installer.lib.pacman.config import PacmanConfig
from morvane_installer.lib.pacman.pacman import Pacman
from morvane_installer.lib.pathnames import MIRRORLIST, PACMAN_CONF
from morvane_installer.lib.plugins import plugins
...
class Installer:
	...
	def genfstab(self, flags: str = '-pU') -> None:
		...
		try:
			gen_fstab = SysCommand(f'fstabgen {flags} -f {self.target} {self.target}').output()
