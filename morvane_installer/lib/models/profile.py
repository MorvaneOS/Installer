...
from morvane_installer.default_profiles.profile import GreeterType, Profile
...
if TYPE_CHECKING:
	from morvane_installer.lib.profile.profiles_handler import ProfileSerialization
