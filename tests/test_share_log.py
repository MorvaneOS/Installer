...
from morvane_installer.lib.log import share_install_log
...
def test_file_not_found(
	...
	with patch('morvane_installer.lib.log.logger._path', new=missing_log):
...
def test_empty_file(log_file: Path, paste_url: str, max_byte: int | None) -> None:
	...
	with patch('morvane_installer.lib.log.logger._path', new=log_file.parent):
		# with patch('morvane_installer.lib.log.logger', _fake_logger(log_file)):
		assert share_install_log(paste_url, max_byte) is None
...
def test_successful_upload(log_file: Path, resp_url: str, paste_url: str, max_byte: int | None) -> None:
	...
	with (
		patch('morvane_installer.lib.log.logger._path', new=log_file.parent),
